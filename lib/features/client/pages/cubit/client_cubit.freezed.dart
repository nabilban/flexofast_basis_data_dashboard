...
mixin _$ClientState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ClientEntityData> result) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ClientEntityData> result)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ClientEntityData> result});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<ClientEntityData> result) : _result = result;

  final List<ClientEntityData> _result;
  @override
  List<ClientEntityData> get result {
  ...
  @override
  String toString() {
    return 'ClientState.loaded(result: $result)';
  }
...
abstract class _Loaded implements ClientState {
  const factory _Loaded(final List<ClientEntityData> result) = _$LoadedImpl;
